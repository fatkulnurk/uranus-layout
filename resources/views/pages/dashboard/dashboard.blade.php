            ...
            <div class="columns">
                ...
                <div class="column is-7">
                    <div class="box">
                        ...
                        <div class="field">
                            <div class="control">
                                <a href="{{ route('web.dashboard.proyek') }}" class="button is-primary is-fullwidth">Lihat
                                    Semua</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        ...
                        <div class="field">
                            <div class="control">
                                <a href="{{ route('web.dashboard.saham') }}" class="button is-primary is-fullwidth">Lihat
                                    Semua</a>
                            </div>
                        </div>
                    </div>
