...
{{--    <!-- Load main hexalight css -->--}}
{{--    <link href="https://demo.creativebulma.net/templates/html/pegasus/assets/css/demo.min.css" rel="stylesheet">--}}
    ...
    <div class="columns is-marginless is-fullpage">
        ...
        <div class="column has-content-vspaced has-padding-large has-background-white">
            ...
            <p class="has-text-centered has-text-grey">
                Sudah punya akun? <a href="{{ route('web.login') }}">Masuk</a>
            </p>
        </div>
    </div>
